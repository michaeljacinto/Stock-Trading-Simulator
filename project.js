...
// password login
mongoose.connect("mongodb+srv://stockTradingSimulator:BqZpk9VBFkWegFTq@cluster0-ulvwp.mongodb.net/accounts", {
...
function check_password(string_input) {
	// checks if string value is atleast 8 characters and 1 letter and 1 number, uses RegEx to confirm only alphanumerical chars
